...
public class SendEmail
{
	...
	public static void main(String[] args) throws MessagingException, IOException
	{
		...
		ManipulatingEmail.saveEmail("MyEmail.eml", message);
		...
		{
			System.err.println("Error : Fail to connect to the server of email !\n");
			e.printStackTrace();
		}
			...
			throws MessagingException, IOException
	{
		...
		image.setContentID("image_Cut_pig_id");// Set a unique number for the node and his ID is referenced in the text
												// "node".
