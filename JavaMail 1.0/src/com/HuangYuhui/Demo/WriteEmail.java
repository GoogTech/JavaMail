 ...
 * @Description (Demo)Basic steps for sending the email.
 * @Author HuangYuhui
...
public class WriteEmail
{
	public static void main(String[] args) throws MessagingException, IOException
	{
		 ...
		 */
		OutputStream outputStream = new FileOutputStream("WriteEmail.eml");
		message.writeTo(outputStream);
		// Release the resource.
		outputStream.flush();
		outputStream.close();

		System.out.println("[ Tip: Write a email successfully ! ]");
	}
}
